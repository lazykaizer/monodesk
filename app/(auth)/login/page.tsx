                    ...
                    <div className="relative z-10 w-full">
                        ...
                        <div className="space-y-5">
                            <div className="grid grid-cols-2 gap-4">
                                <button type="button" onClick={() => handleOAuth('google')} className="flex items-center justify-center gap-3 bg-white/[0.03] border border-white/5 hover:border-orange-500/30 hover:bg-orange-500/[0.02] h-12 rounded-xl transition-all duration-500 group px-4">
                                ...
                                <button type="button" onClick={() => handleOAuth('github')} className="flex items-center justify-center gap-3 bg-white/[0.03] border border-white/5 hover:border-orange-500/30 hover:bg-orange-500/[0.02] h-12 rounded-xl transition-all duration-500 group px-4">
                            ...
                            <form onSubmit={handleLogin} className="space-y-4">
                                <div className="space-y-4">
                                    ...
                                    <div className="relative group/input">
                                        ...
                                        <input type="email" placeholder="founder@startup.com" value={email} onChange={(e) => setEmail(e.target.value)} required className="w-full bg-white/[0.01] border border-white/[0.05] group-hover/input:border-white/10 rounded-2xl py-4 pl-14 pr-4 text-white placeholder:text-white/10 focus:outline-none focus:border-orange-500/50 focus:bg-orange-500/[0.02] transition-all duration-500 ring-0 focus:ring-4 focus:ring-orange-500/10" />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative group/input">
                                            ...
                                            <input type={showPassword ? "text" : "password"} placeholder="••••••••••••" value={password} onChange={(e) => setPassword(e.target.value)} required className="w-full bg-white/[0.01] border border-white/[0.05] group-hover/input:border-white/10 rounded-2xl py-4 pl-14 pr-14 text-white placeholder:text-white/10 focus:outline-none focus:border-orange-500/50 focus:bg-orange-500/[0.02] transition-all duration-500 ring-0 focus:ring-4 focus:ring-orange-500/10" />
                                ...
                                <div className="space-y-6 pt-2">
                                    <div className="flex items-center justify-between px-1">
                                        <label className="flex items-center gap-3 cursor-pointer group">
                                            ...
                                            <span className="text-[11px] text-white/20 group-hover:text-white/40 transition-colors font-bold uppercase tracking-widest">Remember me</span>
                                        </label>
                                    </div>
